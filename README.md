...
```
cd existing_repo
git remote add origin https://gitlab-se.eeecs.qub.ac.uk/40365072/carelink_2.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-se.eeecs.qub.ac.uk/40365072/carelink_2/-/settings/integrations)
