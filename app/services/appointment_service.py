...
class AppointmentService:
    ...
    def get_available_slots(
        ...
        booked_appointments = self.appointment_repo.get_booked_slots_for_date(target_date)
        booked_times = set()
        ...
        while current_hour < self.CLINIC_END_HOUR or (current_hour == self.CLINIC_END_HOUR and current_minute == 0):
